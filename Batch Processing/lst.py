...
class Steinberg:
    ...
    def generatePalette(self):
        ...
        self.palette = np.genfromtxt("./CLR/" + split[0] + '.txt', usecols=(2, 1, 0), dtype=int)
    ...
    def show(self):
        cv2.imwrite("./out/dither_" + split[0] + '.png', self.image)
        print('Saved dither_' + split[0] + '.png to out folder.')
        sys.exit()
