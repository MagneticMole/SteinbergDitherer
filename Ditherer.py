...
class Steinberg:
    ...
    def generateSelectivePalette(self, num_colors):
        """
    ...
    def generateExternalPalette(self):
        """
        Given a list of pepaired tupals in "EXT_VALUES.txt" (space sepreated RGB values, inturn seperated by newlines), generate a palette of colors by creating
        a new array for the Palette variable with values included.
        """
        self.palette = np.genfromtxt("EXT_VALUES.txt", usecols=(2, 1, 0), dtype=int)
